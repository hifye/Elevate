...
public class CourseRepository : ICourseRepository
{
    ...
    /// </returns>
    public async Task<IEnumerable<CourseResponse>> GetAllCoursesByModulesAndLessons()
    {
        var courseDictionary = new Dictionary<Guid, CourseResponse>();
    ...
    /// </returns>
    public async Task<CourseResponse> GetCourseByModuleAndLesson(Guid id)
    {
        var courseDictionary = new Dictionary<Guid, CourseResponse>();
        var moduleDictionary = new Dictionary<int, ModuleResponse>();
    ...
    /// </returns>
    public async Task<CourseResponse> GetAllCoursesByInstructorId(Guid instructorId)
    {
        var courseDictionary = new Dictionary<Guid, CourseResponse>();
